...
namespace AbpQueryFilterDemo.Users
{
    ...
    public class AppUser : FullAuditedAggregateRoot<Guid>, IUser
    {
         ...
         *
         * 1. Update AbpQueryFilterDemoDbContext.OnModelCreating
         * to configure the mapping for your new property
         * 2. Update AbpQueryFilterDemoEfCoreEntityExtensionMappings to extend the IdentityUser entity
